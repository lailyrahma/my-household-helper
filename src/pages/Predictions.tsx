        ...
        <SidebarInset>
          ...
          <div className="flex-1 space-y-4 p-4 pt-6">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold">Prediksi Barang Habis</h1>
                  ...
                  {predictions.map((prediction, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-lg">{prediction.item}</p>
                          <p className="text-sm text-muted-foreground">
                            Stok: {prediction.current} {prediction.unit} • 
                            Konsumsi rata-rata: {prediction.avgConsumption} {prediction.unit}/hari
                          </p>
                        </div>
                      </div>
